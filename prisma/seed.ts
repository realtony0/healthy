    ...
    const products = [
      {
        ...
        kcal: 450,
        proteins: 35,
        image: '/img/Bowl de poulet au Maïs Doré.jpeg',
      ...
      },
      {
        ...
        kcal: 420,
        proteins: 30,
        image: '/img/Poisson blanc et légumes.jpeg',
        categoryId: platsSignature.id,
        sortOrder: 2,
      },
      {
        ...
        proteins: 40,
        image:
          '/img/Bœuf saisi accompagné de purée de patate douce.jpeg',
        categoryId: platsSignature.id,
        sortOrder: 3,
      },
      {
        ...
        kcal: 480,
        proteins: 32,
        image: '/img/Patate douce et bœuf façon tacos.jpeg',
        categoryId: platsSignature.id,
        sortOrder: 4,
      },
      {
        ...
        kcal: 430,
        proteins: 38,
        image: '/img/Poulet grillé et légumes.jpeg',
        categoryId: platsSignature.id,
        sortOrder: 5,
      },
      {
        ...
        kcal: 410,
        proteins: 34,
        image: '/img/Poisson blanc aux herbes et citron.jpeg',
        categoryId: platsSignature.id,
        sortOrder: 6,
      },
      {
    ...
    const products = [
      {
        ...
        proteins: 24,
        image:
          '/img/Bowl de lentilles & Pommes de Terre Croustillantes Veggie.jpeg',
      ...
      },
      {
        ...
        kcal: 320,
        proteins: 26,
        image: '/img/Salade de concombre au poulet.jpeg',
        categoryId: lessentiel.id,
        sortOrder: 2,
      },
      {
        ...
        kcal: 280,
        proteins: 22,
        image: '/img/Barquettes de concombre aux crevettes.jpeg',
        categoryId: lessentiel.id,
        sortOrder: 3,
      },
      {
        ...
        kcal: 270,
        proteins: 21,
        image: '/img/Coupe de laitue au crevettes.jpeg',
        categoryId: lessentiel.id,
        sortOrder: 4,
      },
    ]
    ...
    const products = [
      {
        ...
        kcal: 250,
        proteins: 8,
        image: '/img/energy balls : beurre de cacahouete.jpeg',
